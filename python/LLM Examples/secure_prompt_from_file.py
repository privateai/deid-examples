...
file_summary = prompt_chat_gpt(f"summarize this file: {redaction_response.processed_text}")
print("\n SUMMARY \n")
print("********************** redacted summary **********************")
print(file_summary)
print("********************** REID summary **********************")
reid_req_obj = request_objects.reidentify_text_obj(processed_text=[file_summary],entities=entity_list)
