...
This folder contains a set of javascript examples for interacting with the Limina API. By default the scripts will interact with the Community APIs, but you can also use these as the basis for connecting to the Professional APIs, or to your own running container.
...
1. Get your Community API key from the Limina [Customer Portal](https://portal.getlimina.ai/).
